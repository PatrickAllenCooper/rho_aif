...
def main() -> None:
    ...
    lines = [
        ...
        " objective (Section~\\ref{sec:methodology}). Task value is net of sensing cost, so Total score",
        " $=$ Task value $+\\, w \\cdot$IG, with Cost shown for reference. The chosen action need not have the largest raw information",
