...
**Status**: Stages A–G2 complete (propositions, interleaved curves, multi-seed dual, cost budgets, collapse breadth, SARSOP baseline, w* atlas, distractor robustness), verdicts HOLD (Tileworld collapse PARTIAL, explained as budget-at-knot noise); Stage G2 verdict DONE (IG is reward-blind, budget caps but does not redirect spend; the in-repo IDS adaptation is not a clean immune contrast either); Stage H, I pending
