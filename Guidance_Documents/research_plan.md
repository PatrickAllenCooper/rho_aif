...
**Status**: Stages A (propositions), B (interleaved usage curves), C (multi-seed dual control), D (cost-denominated budgets) complete, all verdict HOLD; Stages E–I pending
