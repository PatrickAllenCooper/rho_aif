...
\begin{enumerate}[leftmargin=*]
  ...
  \item Three headline experiments---curve collapse, Proposition~2 onset, dual rescale---plus supporting shadow-price staircases (Section~\ref{sec:experiments}).
\end{enumerate}
...
\end{equation}
with schedule $\eta_t=\eta_0/(1+\delta t)$. We also track a Polyak average $w_{\mathrm{avg}}$ for monitoring. Sign: when $U$ increases with~$w$, overspend decreases~$w$ and underspend increases it---the same dual logic as SAC temperature tuning~\citep{haarnoja2018sac}, with sensing in place of entropy.
